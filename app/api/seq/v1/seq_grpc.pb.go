...
func (c *seqClient) GetId(ctx context.Context, in *GetIdReq, opts ...grpc.CallOption) (*GetIdResp, error) {
	out := new(GetIdResp)
	err := c.cc.Invoke(ctx, "/seq.v1.Seq/GetId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSeqServer) GetId(context.Context, *GetIdReq) (*GetIdResp, error) {
...
func _Seq_GetId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seq.v1.Seq/GetId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeqServer).GetId(ctx, req.(*GetIdReq))
	}
